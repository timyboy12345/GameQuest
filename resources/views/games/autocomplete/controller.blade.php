    ...
    <div class="w-full max-w-xs mx-auto mt-16">
        <div class="card">
            ...
            <div class="card-footer">
                <div class="btn btn-indigo cursor-pointer">{{ __("Verder spelen") }}</div>
                <div class="btn btn-indigo cursor-pointer">{{ __("Nieuw spel starten") }}</div>
            </div>
        </div>
    </div>

    <div class="w-full max-w-xs mx-auto mt-16" id="loginForm">
